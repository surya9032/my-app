node{
   ...
   stage('tomcat'){
      sh "deploy adapters: [tomcat8(credentialsId: '8aa7ac5e-1b7e-4d89-ac74-0efc063e6c53', path: '', url: 'http://13.127.54.167:8080')], contextPath: null, onFailure: false, war: '**/*.war*'"
   }
